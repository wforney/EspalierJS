...
var EspalierCustomElement = /** @class */ (function () {
    ...
    EspalierCustomElement.prototype.fetch = function () {
        ...
        return this.http.fetch(urlParts[0] + "?" + queryString)
            ...
            if (_this.page > 1) {
                pages.push(new PageInfo(false, false, "&lsaquo;", _this.page - 1));
            }
            for (var i = startAtPage; i <= endAtPage; i++) {
                pages.push(new PageInfo(false, i === _this.page, i.toString(), i));
            }
            ...
            _this.taskQueue.queueMicroTask(function () {
                var buttons = ToArray(_this.tableBody.querySelectorAll("button"));
