        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.settings.dataSource.GetPage(this.page, this.pageSize, this.getSortPropertyName(this.sortColumn), this.sortColumn ? this.sortColumn.sortOrder : SortOrder.NotSpecified, this.filter)];
                    case 1:
                        page = _a.sent();
                        ...
                        this.taskQueue.queueMicroTask(function () {
                            var columnHeads = ToArray(_this.tableHeader.querySelectorAll("th"));
